...
SECRET_KEY = 'django-insecure-&*+=--7p-w9)xftex_yo=&wm8k!wb&vqdo28@^3)tzd+94-e52'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'web.context_processors.school_info_processor',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        # Removed foreign key pragma to avoid conflicts with admin interface
    }
}
